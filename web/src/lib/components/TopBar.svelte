...
<header class="flex items-center justify-between gap-4 border-b border-border bg-surface px-4 py-2.5 shrink-0">
  <!-- Page title -->
  ...
  <div class="flex items-center gap-3">
    ...
    <!-- Connection status -->
    <div class="flex items-center gap-1.5 text-xs text-success" title="Connected" aria-label="Connection status: Connected">
    ...
    <!-- Alerts bell -->
    <a href="/alerts" class="relative p-1.5 rounded-lg text-fg-subtle hover:text-fg hover:bg-surface-muted transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" aria-label="View alerts">
